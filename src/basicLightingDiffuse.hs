...
main
 ...
 = do
  ...
  -- Load shaders
  vs <- loadShaderFromFile VertexShader "basicLightingDiffuse.vert"
  fs <- loadShaderFromFile FragmentShader "basicLightingDiffuse.frag"
  lfs <- loadShaderFromFile FragmentShader "basicLightingDiffuseLight.frag"
